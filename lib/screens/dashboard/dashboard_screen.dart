...
class _GreetingSection extends StatelessWidget {
  ...
  const _GreetingSection({super.key, required this.userName});
...
class _SectionTitle extends StatelessWidget {
  ...
  const _SectionTitle({super.key, required this.title, required this.onSeeAll});
...
class _UpcomingPlaydatesSection extends StatelessWidget {
  const _UpcomingPlaydatesSection({super.key});
...
class _RemindersSection extends StatelessWidget {
  const _RemindersSection({super.key});
...
class _MyDogsSection extends StatelessWidget {
  const _MyDogsSection({super.key});
